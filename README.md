...
##  flexoki-material.nvim

An nvim theme mostly taken from [Flexoki](https://github.com/kepano/flexoki), built on [material.nvim](https://github.com/marko-cerovac/material.nvim).
...
use 'pbdeuchler/flexoki-material.nvim'
```
...
```lua
--Lua:
vim.cmd 'colorscheme flexoki-material'
```
...
```lua
require('flexoki-material').setup({
